...
<div class="col-sm-4">
<input type="text" name="fullname" class="form-control" pattern="[a-zA-Z]{1,}" required>
</div>
...
<div class="col-sm-4">
<input type="text" name="age" onKeyPress="return isNumberKey(event)"  maxlength="3" class="form-control" required>
</div>
...
<div class="col-sm-10">
<input type="text" name="pincode" onKeyPress="return isNumberKey(event)"  maxlength="6" class="form-control" required>
</div>
